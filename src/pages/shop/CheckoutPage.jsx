...
const CheckoutPage = () => {
  ...
  return (
    <div className="container max-w-2xl px-4 py-10 mx-auto">
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-6 bg-gray-100 shadow rounded-xl">
        <div>
        ...
        <div>
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center justify-between w-full px-4 py-2 text-left bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"
            >
              ...
              <ul className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-md">
                {paymentOptions.map((option) => (
                  <li
                    ...
                    className={`px-4 py-2 cursor-pointer rounded-md hover:bg-amber-600 hover:text-white ${
